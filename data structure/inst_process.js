...
order_management_inst_1 = {
	organization: "SC1",
	documents: ["so_doc_1"],
	status: "check_material_availability", // changed to 'create_sales_order' on process start then to 'check_material_availability' on action
	steps: {
		create_sales_order: {
			options: {
...
order_management_inst_1 = {
	organization: "SC1",
	documents: ["so_doc_1"],
	status: "ship_goods", // changed to 'ship_goods' on action
	steps: {
		create_sales_order: {
			options: {
				cancel: {label: "Cancel", actions: {}}, // on UI this leads to "Home" page
...
order_management_inst_1 = {
	organization: "SC1",
	documents: ["so_doc_1"],
	status: "TERMINATED", // changed to 'end' on action
	steps: {
		create_sales_order: {
			options: {
				cancel: {label: "Cancel", actions: {}}, // on UI this leads to "Home" page
